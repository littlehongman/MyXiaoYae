        ...
        <div id="food">
            ...
            <div class="row ml-5 mr-0 my-1" style="white-space:nowrap;display:inline">
                <h1 class=" col-sm-11">
                    ...
                    <button type="button" class="btn btn-warning button_pc" @click="countByPerson()">每個人金額統計</button>
                    <button type="button" class="btn btn-warning button_pc" @click="countByStore()">每家店金額統計</button>
                    <button type="button" class="btn btn-warning button_pc" @click="countByFood()">每種食物數量統計</button>              
